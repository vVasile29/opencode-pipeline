...
```bash
curl -fsSL https://raw.githubusercontent.com/YOUR_USER/opencode-pipeline/main/install.sh | bash
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/YOUR_USER/opencode-pipeline/main/select-models.sh | bash
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/YOUR_USER/opencode-pipeline/main/auto-select-models.sh | bash
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/YOUR_USER/opencode-pipeline/main/uninstall.sh | bash
```
